...
const FilterDriversBySource = ({selectedBySourceValue, handleFilterBySource}) => (
  <div className={styles.filterContainer}>
    <select value={selectedBySourceValue} onChange={handleFilterBySource} name='filterBySource' id='filterBySource' className={styles.filterBtn}>
